                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="projNo" name="projNo" class="form-control"
                               value="${projDic.projNo}"  placeholder="项目编号" />
                    </div>
                </div>
                <div class="col-md-2 text-left"
                     style="background-color: #FFEEDD; line-height: 26px; vertical-align: middle;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="projName" name="projName"
                               value="${projDic.projName}" class="form-control" placeholder="项目名称" />
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="totalFee" name="totalFee"
                               value="${projDic.totalFee}" class="form-control" placeholder="项目金额" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
                <div class="col-md-2 text-left"
                     style="background-color: #FFEEDD; line-height: 26px; vertical-align: middle;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="leftFee" name="leftFee"
                               value="${projDic.leftFee}" class="form-control" placeholder="应收尾款" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="ratio1" name="ratio1"
                               value="${projDic.ratio1}" class="form-control" placeholder="项目战略意义系数15~30" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
                <div class="col-md-2 text-left"
                     style="background-color: #FFEEDD; line-height: 26px; vertical-align: middle;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="ratio2" name="ratio2"
                               value="${projDic.ratio2}" class="form-control" placeholder="项目实施难度系数30~50" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="ratio3" name="ratio3"
                               value="${projDic.ratio3}" class="form-control" placeholder="项目实施周期系数5~15" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
                <div class="col-md-2 text-left"
                     style="background-color: #FFEEDD; line-height: 26px; vertical-align: middle;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="ratio4" name="ratio4"
                               value="${projDic.ratio4}" class="form-control" placeholder="项目收益程度系数5~15" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" id="ratio5" name="ratio5"
                               value="${projDic.ratio5}" class="form-control" placeholder="项目维护成本系数15~25" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
